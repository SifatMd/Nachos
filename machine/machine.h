...
// Routines internal to the machine simulation -- DO NOT call these
    ...
    bool ReadMem(int addr, int size, int* value); //content of addr is written to value by size amount
    bool WriteMem(int addr, int size, int value); //content of value is written to addr by size amount
